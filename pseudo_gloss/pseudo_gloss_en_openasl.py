"""
OpenASL Pseudo Gloss Generator (English)
...
tsv_path = "./assets/openasl/openasl-v1.0.tsv"
output_path = "data/openasl/processed_words.pkl"
...
# Use raw-text column for sentences
sentences = df["raw-text"].unique()
...
print("\n=== Example Sentences ===")
examples = list(dict_sentence.items())[:5]
for sent, glosses in examples:
    print(f"\nOriginal: {sent[:80]}..." if len(str(sent)) > 80 else f"\nOriginal: {sent}")
    print(f"Pseudo glosses: {glosses}")
